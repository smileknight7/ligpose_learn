...
def process(task):
    ...
    dic_pocket = process_pdbbind(pdb_id, data_path, suppl_path, cache_path)
    ...
    dic_ligand = process_pdbbind(pdb_id, data_path, suppl_path, cache_path)
    # print(f"{pdb_id}: {dic_data is not None}")检验是否能够构建dic_data字典
...
#argparse是python内置的命令行参数解析模块
    ...
    parser.add_argument('--data_path', type=str,
                        default= '/home/smileknight/learn/ligpose_data/refined_set_10', help='data path')
    parser.add_argument('--data_suppl_path', type=str,
                        default= '/home/smileknight/learn/ligpose_data/INDEX_refined_set_10.txt', help='suppl path')

    # output
    parser.add_argument('--output_path', type=str,
                        default= '/home/smileknight/learn/ligpose_data/test', help='prepared path')
