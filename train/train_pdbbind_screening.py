...
if __name__ == '__main__':
    ...
    parser.add_argument('--allow_dict_path', type=str,
                        default='/home/lpw/ligpose_learn/suppl/filtered_pdbbind_screening_allow_dict.pkl',
                        help='dataset path')
    parser.add_argument('--choose_start_weight', type=str,
                        default=None,
                        help='init weight (restart=0), None for random')
    parser.add_argument('--choose_main_net_start_weight', type=str,
                        default=None,
                        help='init main_net weight, None for random')
    ...
    parser.add_argument('--data_list_path', type=str,
                        default='/home/lpw/ligpose_learn/eval/pdbbind/core_test',
    ...
    parser.add_argument('--blind_training', type=str,
                        default=True, help='Blind training')
    ...
    parser.add_argument('--aff_scale', type=int, default=1000, help='affinity scaler for nM values')


    # model hyperparameters
    parser.add_argument('--max_len_before_sampling', type=int, default=800, help='max number of atoms in complex')
    parser.add_argument('--max_len_after_sampling', type=int, default=200, help='max number of atoms in complex')
    parser.add_argument('--max_len_after_sampling_for_eval', type=int, default=200, help='max number of atoms in complex')
    ...
    parser.add_argument('--gamma_1', type=float, default=0.2, help='loss weight')
    parser.add_argument('--gamma_2', type=float, default=1.0, help='loss weight')
    parser.add_argument('--gamma_3', type=float, default=1.0, help='loss weight')
    ...
    # device settings
    parser.add_argument('--use_seed', type=str, default=False, help='use random seed')
    ...
    parser.add_argument('--gpu_list', type=str, default='1', help='available GPU list')
    ...
    parser.add_argument('--vis', type=str, default=True, help='save visualization')
